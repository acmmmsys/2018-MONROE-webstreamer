 ...
 * @param {string} vid -  url of webrtc-streamer (default is current location)
*/
 ...
 * @param {string} videovid -  local stream to send

*/
WebRtcStreamer.prototype.connect = function(videourl, audiourl, options, stream, videovid) {
	this.disconnect();
